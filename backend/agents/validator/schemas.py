...
class TruthTestResult(BaseModel):
    ...
    expected_value: Optional[str] = Field(
        None, description="The value / result that was expected (computed from document rules)"
    )
    actual_value: Optional[str] = Field(
        None, description="The value that was actually found in the extracted data"
    )
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "source_file": "outputs/extracted/20260306_invoice/extraction.json",
